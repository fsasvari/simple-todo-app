...
<form method='post' action='<?php echo $canonical; ?>'>
	...
	<div class='form-group'>
		...
		<div class='input-group'>
			<input type='text' name='password' id='password' value='' placeholder='<?php echo $lang->get('form.register.password_repeat'); ?>' maxlength='30' class='form-input'>
	...
	<div class='form-group'>
		...
		<div class='input-group'>
			<input type='text' name='password_repeat' id='password_repeat' value='' placeholder='<?php echo $lang->get('form.register.password_repeat'); ?>' maxlength='30' class='form-input'>
			<span class='input-group-addon'><i class='fa fa-lock'></i></span>
		</div>
	</div>
	...
	<div class='form-group'>
		...
		<div class='input-group'>
			<input type='text' name='firstname' id='firstname' value='' placeholder='<?php echo $lang->get('form.register.firstname'); ?>' maxlength='30' class='form-input'>
	...
	<div class='form-group'>
		...
		<div class='input-group'>
			<input type='text' name='lastname' id='lastname' value='' placeholder='<?php echo $lang->get('form.register.lastname'); ?>' maxlength='30' class='form-input'>
